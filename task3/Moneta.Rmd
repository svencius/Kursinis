...
```{r}
mean(replicate(1000, balansas(1))>0) 
mean(replicate(1000, balansas(2))>0)
mean(replicate(1000, balansas(5))>0) 
mean(replicate(1000, balansas(10))>0) 
mean(replicate(1000, balansas(20))>0) 
mean(replicate(1000, balansas(100))>0)
```
